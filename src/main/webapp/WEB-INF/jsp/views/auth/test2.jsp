            ...
            <div class="layer-text">
                <div class="page-left-2">
                    ...
                    <div class="page-text w-richtext">
                        <h3><strong>PDP</strong></h3>

                        <p>‍</p>
                        <p>"He who has a Why to live for can bear almost any How"
                            – Friedrich Nietzsche</p>
                        <br/>
                        <p>"We may encounter many defeats but we must not be defeated"
                            – Maya Angelou</p>
                        <br/>

                        <p>"Hardships often prepare ordinary people for an extraordinary destiny"
                            – C.S. Lewis</p>
                        <br/>

                        <p>"The secret of life is to fall seven times and to get up eight times"
                            – from The Alchemist, by Paulo Coelho</p>
                        <br/>

                        <p>"The only way to find true happiness is to risk being completely cut open"
                            – Chuck Palahniuk</p>
                        <br/>

                        <p>"The best way to cheer yourself is to try to cheer someone else up"
                            – Mark Twain.</p>
                    </div>
                </div>
            </div>
                ...
                <div class="page-right-2">
                    <div class="page-text w-richtext">
                        ...
                        <p>"Books are the quietest and most constant of friends; they are the most accessible and wisest
                            ...
                            – Charles W. Eliot </p>
                        <p>‍</p>
                        <p>"If you don’t like to read, you haven’t found the right book"

                            – J.K. Rowling </p>
                        <p>‍</p>
                        <p>"That’s the thing about books. They let you travel without moving your feet."

                            – Jhumpa Lahiri </p>
                        <p>‍</p>
                        <p>"A book is a version of the world. If you do not like it, ignore it; or offer your own
                            version
                            in return."
                            – Salman Rushdie </p>
                    </div>
